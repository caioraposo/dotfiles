...
lexers.STYLE_DEFAULT		= 'back:'..colors.bg0..',fore:'..colors.fg1
...
lexers.STYLE_DEFINITION		= 'fore:'..colors.yellow
lexers.STYLE_ERROR			= 'fore:'..colors.red..',back:'..colors.bg0..',reverse'
lexers.STYLE_FUNCTION		= 'fore:'..colors.green..',bold'
...
lexers.STYLE_PREPROCESSOR		= 'fore:'..colors.aqua
...
lexers.STYLE_IDENTIFIER		= 'fore:'..colors.blue

lexers.STYLE_LINENUMBER		= 'fore:'..colors.bg4
lexers.STYLE_LINENUMBER_CURSOR	= 'fore:'..colors.yellow..',back:'..colors.bg1
lexers.STYLE_CURSOR			= 'reverse'
lexers.STYLE_CURSOR_PRIMARY		= lexers.STYLE_CURSOR..',fore:'..colors.yellow
lexers.STYLE_CURSOR_LINE		= 'back:'..colors.bg1
lexers.STYLE_COLOR_COLUMN		= 'reverse'
lexers.STYLE_SELECTION		= 'back:'..colors.bg3..',reverse'
lexers.STYLE_STATUS			= 'fore:'..colors.bg1..',back:'..colors.fg4..',reverse'
lexers.STYLE_STATUS_FOCUSED		= 'fore:'..colors.bg2..',back:'..colors.fg1..',reverse'
lexers.STYLE_SEPARATOR		= 'fore:'..colors.bg3
